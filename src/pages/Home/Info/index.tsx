...
import timg from 'src\assets\images\timg.jpg';
    ...
    <Spin spinning={meetingInfoR.loading}>
      <form className={style.container} onSubmit={handleApply}>
        <div className={style.header}>
          ...
          <Modal
            title="接机和住宿服务"
            visible={showModal && auth.isLogin}
        ...
        <div className={style.meetingImg}>
          ...
          <Image
            ...
            style={{position: "relative",
              left: 200 + "px"}}
          />
          {/* <img src = "src\assets\images\timg.jpg"></img>  */}
        </div>
        ...
        <div className={style.meetingGuest}>
          <h2>出席嘉宾</h2>
          <div className="meetingGuestContainer"><GuestC list={guests} /></div>
        </div>
